        ...
        >
          ...
          {registrationType === 'Driver' && (
            <>
              ...
              <TextInput style={[styles.input, { backgroundColor: themeStyles.inputBackground, color: themeStyles.textColor }]} placeholder="Driving License Number" placeholderTextColor={themeStyles.placeholderTextColor} value={drivingLicense} onChangeText={setDrivingLicense} />
              <TextInput style={[styles.input, { backgroundColor: themeStyles.inputBackground, color: themeStyles.textColor }]} placeholder="Car Plate Number" placeholderTextColor={themeStyles.placeholderTextColor} value={carPlate} onChangeText={setCarPlate} />
              <TextInput style={[styles.input, { backgroundColor: themeStyles.inputBackground, color: themeStyles.textColor }]} placeholder="Vehicle Brand" placeholderTextColor={themeStyles.placeholderTextColor} value={vehicleBrand} onChangeText={setVehicleBrand} />
              <TextInput style={[styles.input, { backgroundColor: themeStyles.inputBackground, color: themeStyles.textColor }]} placeholder="Total Seats (excluding driver)" placeholderTextColor={themeStyles.placeholderTextColor} value={totalSeats} onChangeText={setTotalSeats} keyboardType="numeric" />
